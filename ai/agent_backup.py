...
# ============================================================
# CONFIG FILE (device_id + user session)
# ============================================================
def load_config():
    global DEVICE_ID
...
# ============================================================
# EXECUTOR  ← ⚠️ THE ONLY 2 LINES THAT CHANGED
# ============================================================
def execute_action(action, data):
    ...
    try:
        ...
        elif action == "SET_VOLUME": return set_volume(data.get("level", data.get("value", 50)))       # ← FIXED
        elif action == "BRIGHTNESS_UP": return brightness_up()
        elif action == "BRIGHTNESS_DOWN": return brightness_down()
        elif action == "SET_BRIGHTNESS": return set_brightness(data.get("level", data.get("value", 50)))  # ← FIXED
